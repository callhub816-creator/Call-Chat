...
/**
 * Wrapper component for message items that adds selection checkbox support
 * Renders a checkbox on the left when in select mode
 * Handles long-press to enter select mode
 */
