      ...
      <div className="max-w-2xl mx-auto px-6 py-8 space-y-8">
        ...
        <section className="bg-white/40 border border-white/60 rounded-2xl p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h3 className="text-lg font-bold text-[#4A2040]">Emotional Safety</h3>
          </div>
          <p className="text-sm leading-relaxed opacity-90 text-[#5e3a58]">
            CallHub AI characters are here to listen, chat, and provide companionship. While they offer emotional comfort and conversation, please remember they are virtual entities. Interactions should not replace professional medical, legal, or psychological advice from real-world experts.
          </p>
        </section>
        ...
        {/* 5. Mental Wellbeing Note */}
        <section className="bg-white/40 border border-white/60 rounded-2xl p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-3">
            <Sparkles size={20} className="text-[#A78BFA]" />
            <h3 className="text-lg font-bold text-[#4A2040]">Mental Wellbeing</h3>
          </div>
          <p className="text-sm leading-relaxed opacity-90 text-[#5e3a58]">
            AI companionship can be a wonderful source of support and entertainment, but it cannot diagnose or treat mental health conditions. If you are going through a crisis or need serious help, please encourage yourself to reach out to a real-world professional, counselor, or helpline.
          </p>
        </section>
