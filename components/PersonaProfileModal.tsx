...
import { X, MessageCircle, Phone, Heart, Share2, ShieldCheck, Sparkles } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-[60] flex items-end sm:items-center justify-center">
      ...
      ">
          ...
          <div className="absolute bottom-0 left-0 w-full p-6 pt-12 bg-gradient-to-t from-[#FFF0F5] to-transparent">
             ...
             <div className="flex items-center gap-2">
                <span className="px-2 py-0.5 rounded-md bg-[#B28DFF] text-white text-[10px] font-bold uppercase tracking-widest">
                  {persona.gender === 'female' ? 'Girlfriend' : 'Boyfriend'}
                </span>
        ...
        <div className="flex-1 px-6 pb-8 space-y-6">
           ...
           <div className="space-y-4">
              <div>
                ...
                <p className="text-[#6D4C63] text-sm leading-relaxed">
                  {persona.description} {persona.basePrompt.includes("Romantic") ? "I love deep conversations and connecting on an emotional level." : "I'm here to bring some excitement and fun into your day."}
                </p>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                   {['Late Night Talks', 'Music', 'Romance', 'Travel'].map((intr, i) => (
           ...
           <div className="pt-6 border-t border-[#8E6A88]/10 flex justify-center">
